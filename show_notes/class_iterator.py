...
"""
Notes:
This is a custom class iterator that loops through a list
ptinting out and switching to next entry with every call.

Has the ability to restart to the beginning of the list
